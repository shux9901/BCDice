  ...
  TABLES = {
    'CC' => SparseTable.new(
      ...
      [
        ...
        [ 5, '相手の急所に命中。激痛のため気絶した上、胴にHWダメージ。'],
        [ 6, '効果的な一撃。胴にHWダメージ。心理チェック。'],
        [ 7, '効果的な一撃。胴にMOダメージ。心理チェック。'],
        [10, '君の一撃は相手の中枢を完全に破壊した。即死である。'],
      ],
    ...
    'ACS' => SparseTable.new(
      ...
      '1D10',
      [
        [ 3, '足を滑らせて転倒し、起き上がるまで相手に+20の命中修正を与える。'],
        [ 6, '手を滑らせて、武器を落とす。素手の時は関係ない。'],
        [ 9, '使用武器の破壊。素手戦闘のときはMWのダメージを受ける。'],
